...
async function main() {
  ...
  const gridData = [
    // ROW 0
    { row: 0, col: 0, type: 'CLUE', arrowDir: 'RIGHT', clueText: 'Korkunç\nhayal', ans: 'FOBİ' },
    { row: 0, col: 1, type: 'LETTER', answer: 'F' },
    { row: 0, col: 2, type: 'LETTER', answer: 'O' },
    { row: 0, col: 3, type: 'LETTER', answer: 'B' },
    { row: 0, col: 4, type: 'LETTER', answer: 'İ' },
    { row: 0, col: 5, type: 'CLUE', arrowDir: 'DOWN', clueText: 'Yön' },
    { row: 0, col: 6, type: 'CLUE', arrowDir: 'RIGHT', clueText: 'Bir kadının\neşi', ans: 'KOCA' },
    { row: 0, col: 7, type: 'LETTER', answer: 'K' },
    { row: 0, col: 8, type: 'LETTER', answer: 'O' },
    { row: 0, col: 9, type: 'LETTER', answer: 'C' },
    { row: 0, col: 10, type: 'LETTER', answer: 'A' },
    { row: 0, col: 11, type: 'CLUE', arrowDir: 'DOWN', clueText: 'Sayı' },
    { row: 0, col: 12, type: 'CLUE', arrowDir: 'RIGHT', clueText: 'Yabancı', ans: 'EL' },
    { row: 0, col: 13, type: 'LETTER', answer: 'E' },
    { row: 0, col: 14, type: 'LETTER', answer: 'L' },

    // ROW 1
    { row: 1, col: 0, type: 'BLOCK' },
    { row: 1, col: 1, type: 'CLUE', arrowDir: 'RIGHT', clueText: 'Görüngü\nbilimi', ans: 'FEN' },
    { row: 1, col: 2, type: 'LETTER', answer: 'F' },
    { row: 1, col: 3, type: 'LETTER', answer: 'E' },
    { row: 1, col: 4, type: 'LETTER', answer: 'N' },
    { row: 1, col: 5, type: 'LETTER', answer: 'O' },
    { row: 1, col: 6, type: 'BLOCK' },
    { row: 1, col: 7, type: 'CLUE', arrowDir: 'RIGHT', clueText: 'Sinirbilim', ans: 'NÖR' },
    { row: 1, col: 8, type: 'LETTER', answer: 'N' },
    { row: 1, col: 9, type: 'LETTER', answer: 'Ö' },
    { row: 1, col: 10, type: 'LETTER', answer: 'R' },
    { row: 1, col: 11, type: 'LETTER', answer: 'O' },
    { row: 1, col: 12, type: 'BLOCK' },
    { row: 1, col: 13, type: 'BLOCK' },
    { row: 1, col: 14, type: 'BLOCK' },

    // ROW 2
    { row: 2, col: 0, type: 'CLUE', arrowDir: 'RIGHT', clueText: 'Kamıştan\nçalgı', ans: 'NEY' },
    { row: 2, col: 1, type: 'LETTER', answer: 'N' },
    { row: 2, col: 2, type: 'LETTER', answer: 'E' },
    { row: 2, col: 3, type: 'LETTER', answer: 'Y' },
    { row: 2, col: 4, type: 'CLUE', arrowDir: 'DOWN', clueText: 'İri' },
    { row: 2, col: 5, type: 'CLUE', arrowDir: 'RIGHT', clueText: 'Baba, cet', ans: 'ATA' },
    { row: 2, col: 6, type: 'LETTER', answer: 'A' },
    { row: 2, col: 7, type: 'LETTER', answer: 'T' },
    { row: 2, col: 8, type: 'LETTER', answer: 'A' },
    { row: 2, col: 9, type: 'CLUE', arrowDir: 'DOWN', clueText: 'Eski dilde\nyuva' },
    { row: 2, col: 10, type: 'CLUE', arrowDir: 'RIGHT', clueText: 'İl', ans: 'OT' },
    { row: 2, col: 11, type: 'LETTER', answer: 'O' },
    { row: 2, col: 12, type: 'LETTER', answer: 'T' },
    { row: 2, col: 13, type: 'CLUE', arrowDir: 'DOWN', clueText: 'Gayret\netme' },
    ...
    { row: 3, col: 6, type: 'CLUE', arrowDir: 'RIGHT', clueText: 'Kurtulma', ans: 'KAR' },
    { row: 3, col: 7, type: 'LETTER', answer: 'K' },
    { row: 3, col: 8, type: 'LETTER', answer: 'A' },
    { row: 3, col: 9, type: 'LETTER', answer: 'R' },
    { row: 3, col: 10, type: 'CLUE', arrowDir: 'RIGHT', clueText: 'Öğrenciye\nverilen not', ans: 'NOT' },
    { row: 3, col: 11, type: 'LETTER', answer: 'N' },
    { row: 3, col: 12, type: 'LETTER', answer: 'O' },
    { row: 3, col: 13, type: 'LETTER', answer: 'T' },
    { row: 3, col: 14, type: 'CLUE', arrowDir: 'DOWN', clueText: 'Yön' },

    // ROW 4
    { row: 4, col: 0, type: 'CLUE', arrowDir: 'RIGHT', clueText: 'Utanma\nduygusu', ans: 'AR' },
    ...
    { row: 5, col: 1, type: 'CLUE', arrowDir: 'RIGHT', clueText: 'Şehzade\neğitmeni', ans: 'ANA' },
    ...
    { row: 5, col: 6, type: 'CLUE', arrowDir: 'RIGHT', clueText: 'Eski dilde\ndamar', ans: 'OK' },
    ...
    { row: 7, col: 10, type: 'CLUE', arrowDir: 'RIGHT', clueText: 'Casus', ans: 'AJ' },
    { row: 7, col: 11, type: 'LETTER', answer: 'A' },
    { row: 7, col: 12, type: 'LETTER', answer: 'J' },
    ...
    { row: 8, col: 10, type: 'CLUE', arrowDir: 'RIGHT', clueText: 'Alfabenin\nilk harfi', ans: 'A' },
    { row: 8, col: 11, type: 'LETTER', answer: 'A' },
    { row: 8, col: 12, type: 'BLOCK' },
    { row: 8, col: 13, type: 'BLOCK' },
    { row: 8, col: 14, type: 'BLOCK' },
  ];

  const title = 'Genel Kültür Bulmacası - 8';

  await prisma.puzzle.deleteMany({
    where: {
      title: {
        in: ['Korkunç Hayal Bulmacası (Resimdeki)', title],
      },
    },
  });
