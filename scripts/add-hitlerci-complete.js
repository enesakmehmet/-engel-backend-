...
async function main() {
  ...
  // Sarı hücreler = CLUE (ipucu), Beyaz hücreler = LETTER (harf), Koyu hücreler = BLOCK
  
  const gridData = [
    // Satır 0 - İpucu satırı
    ...
    { row: 3, col: 1, type: 'LETTER', answer: 'Y' },
    { row: 3, col: 2, type: 'LETTER', answer: 'A' },
    { row: 3, col: 3, type: 'LETTER', answer: 'V' },
    { row: 3, col: 4, type: 'LETTER', answer: 'A' },
    { row: 3, col: 5, type: 'LETTER', answer: 'N' },
